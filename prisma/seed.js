...
async function main() {
  ...
  const productos = [
    { id: 'prod-001', name: 'Nike Air Force 1 Blancas', slug: 'nike-af1-blancas', description: 'El clasico que nunca falla.', price: 280000, basePrice: 280000, category: 'Casuales', active: true, isSpecial: false, salesCount: 45, imageUrl: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80', sku: 'NK-AF1-W-001', taxRate: 19, color: 'Blanco', model3dUrl },
